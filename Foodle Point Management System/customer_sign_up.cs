...
namespace Foodle_Point_Management_System
{
    public partial class frmCustomerSignUp: Form
    {
        ...
        private void btnSignUp_Click(object sender, EventArgs e)
        {
            ...
            CustomerTable myCustomerTable = new CustomerTable("Data Source=10.101.62.24,1433;Initial Catalog=ioop_db;User ID=anderson_login;Password=123;Encrypt=True;Trust Server Certificate=True");
